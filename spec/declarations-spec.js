...
describe('Style declaration processor', function() {
  ...
  it('should not loose simple properties after a -ko-property', function() {
    ...
    previewBindings = elaborateDeclarations(undefined, declarations, '.', mockedBindingProvider);
  ...
  it('should mantain spaces and ; when removing/replacing declarations', function() {
    var result;
    result = elaborateDeclarations('color: red; -ko-color: @color; background-color: white', undefined, '.', mockedBindingProvider);
  ...
  it('should correctly parse multiline declarations', function() {
    ...
    result = elaborateDeclarations('\tcolor: red;\n\t-ko-color: @color;\n\tbackground-color: white\n', undefined, '.', mockedBindingProvider);
    expect(result).toEqual("\tcolor: red;\n\tcolor: <!-- ko text: $color[red]() -->red<!-- /ko -->;\n\tbackground-color: white\n");
  });

  it('should support modifiers', function() {
    var result;
    result = elaborateDeclarations('width: 10%; -ko-width: @[mywidth]%', undefined, '.', mockedBindingProvider);
    expect(result).toEqual("width: 10%; width: <!-- ko text: $mywidth[10]()+'%' -->10%<!-- /ko -->");

    result = elaborateDeclarations('width: 10px; -ko-width: @[mywidth]px', undefined, '.', mockedBindingProvider);
    expect(result).toEqual("width: 10px; width: <!-- ko text: $mywidth[10]()+'px' -->10px<!-- /ko -->");

    result = elaborateDeclarations('src: url(\'path\'); -ko-src: url(\'@myurl\')', undefined, '.', mockedBindingProvider);
  ...
  it('should be able to remove display: none', function() {
    var result;
    result = elaborateDeclarations('a: 1; display: none; b: 2', undefined, '.', mockedBindingProvider, undefined, undefined, true);
    expect(result).toEqual("a: 1; ; b: 2");
  });

  it('should support composed properties and hardcoded values', function() {
    var result;
    result = elaborateDeclarations('border: 1px 2px 3px 4px; -ko-border: @border1 @border2 3px @border4', undefined, '.', mockedBindingProvider);
  ...
  it('should support conditional properties', function() {
    ...
    declarations = styleSheet.stylesheet.rules[0].declarations;
    result = elaborateDeclarations(undefined, declarations, '.', mockedBindingProvider);
    expect(result).toEqual("virtualAttrStyle: 'color: '+(($mycondition[undefined]()) ? $mycolor[undefined]() : null)+';'+''");

    result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-if: mycondition', undefined, '.', mockedBindingProvider);
  ...
  it('should support simple expressions in conditional properties', function() {
    ...
    result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-if: mycondition gt 1 and mycondition lt 3', undefined, '.', mockedBindingProvider);
    expect(result).toEqual("color: red; color: <!-- ko text: ((($mycondition[undefined]() > 1) && ($mycondition[undefined]() < 3))) ? $mycolor[red]() : null -->red<!-- /ko -->; ");

    result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-ifnot: mycondition gt 1 and mycondition lt 3', undefined, '.', mockedBindingProvider);
    expect(result).toEqual("color: red; color: <!-- ko text: !((($mycondition[undefined]() > 1) && ($mycondition[undefined]() < 3))) ? $mycolor[red]() : null -->red<!-- /ko -->; ");

    result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-ifnot: mycondition eq "ciao ciao"', undefined, '.', mockedBindingProvider);
  ...
  it('should support complex expressions in conditional properties', function() {
    var result;
    result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-ifnot: mycondition eq "ciao ciao" and mycondition neq "miao" or mycondition lte 1 or Color.lighter(mycondition, "#00000") gte "#CCCCCC"', undefined, '.', mockedBindingProvider);
    ...
    result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-ifnot: !mycondition || true ? myobj.color : "red"', undefined, '.', mockedBindingProvider);
  ...
  it('should expect defaults', function() {
    ...
    try {
      result = elaborateDeclarations('-ko-color: red', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    ...
    try {
      result = elaborateDeclarations('color: red blue; -ko-color: @a @b @c @d', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should raise an exception on unknown tokens in condition expressions', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-if: mycondition gt 1 xor mycondition lt 3', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
    ...
    try {
      result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-if: mycondition gtn 1', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should raise an exception on element styles applied with no element', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('-ko-attr-href: @myhref', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
    ...
    try {
      result = elaborateDeclarations('-ko-bind-text: @mytext', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should raise an exception on unbalanced string values', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('color: red; -ko-color: @mycolor; -ko-color-if: mycondition eq "ciao ciao"a', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should raise an exception when -if and -ifnot are used on the same property', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('color: red; -ko-color-ifnot: mycondition; -ko-color: @mycolor; -ko-color-if: mycondition eq "ciao ciao"', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should raise errors on bad modifiers', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('src: url(\'path\'); -ko-src: @[myurl!mymod]', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should raise errors on missing default value', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('-ko-color: @mycolor', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
  ...
  it('should not alter the result when no -ko declarations are used', function() {
    var result;
    result = elaborateDeclarations('width: 10%; width: 20%', undefined, '.', mockedBindingProvider);
  ...
  it('should raise errors on unexpected default values when using modifiers', function() {
    var result, exception;
    try {
      result = elaborateDeclarations('width: 10%; -ko-width: @[mywidth]px', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
    ...
    try {
      result = elaborateDeclarations('width: 10px; -ko-width: @[mywidth]%', undefined, '.', mockedBindingProvider);
    } catch (e) {
      exception = e;
    }
    expect(result).toEqual(undefined);
